...
export const MOVIE_PROFILE_PAGE = `${INDEX}/movies/:profileId`;
export const PLANETS_LIST_PAGE = `${INDEX}/planets`;
export const PLANET_PROFILE_PAGE = `${INDEX}/planets/:profileId`;
